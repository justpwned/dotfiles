...
beautiful.get().wallpaper = "/home/joiput/Pictures/Wallpapers/Surface Wallpapers/Surface Book 3.jpg"
local tray_spacing = 10
beautiful.systray_icon_spacing = tray_spacing
...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mywibox:setup({
		...
		{ -- Left widgets
			...
			--mylauncher,
			logout_menu_widget{
                onlock = function() awful.spawn.with_shell('gnome-screensaver-command -l') end
            },
			s.mytaglist,
			s.mypromptbox,
		},
...
globalkeys = gears.table.join(
	...
	-- Sound control (don't mind weird key names)
	...
	end, { description = "Play-pause", group = "volume" }),
	...
	end, { description = "Previous track", group = "volume" }),

	-- Edit config
	awful.key({ modkey, "Control" }, "c", function()
		awful.spawn(editor_cmd .. " " .. awesome.conffile)
	end, { description = "Edit awesome config", group = "awesome" }),

	-- Launch apps
	awful.key({ modkey }, "e", function()
		awful.spawn("nautilus", false)
	end, { description = "Launch file explorer", group = "apps" }),
	...
	awful.key({ modkey, "Control" }, "b", function()
		awful.spawn("firefox-developer", false)
	end, { description = "Launch dev browser", group = "apps" }),

	awful.key({ modkey }, "t", function()
		awful.spawn("flatpak run org.telegram.desktop", false)
	end, { description = "Launch telegram", group = "apps" }),

	awful.key({ modkey }, "v", function()
		awful.spawn("protonvpn", false)
	end, { description = "Launch ProtonVPN", group = "apps" })
)
...
-- MacOS like title bars
--local nice = require("nice")
--nice {
--    --titlebar_color = "#00ff00",
--    titlebar_height = 34,
--    button_size = 14,
--    titlebar_padding_right = 100,
--    titlebar_font = "JetBrainsMono Nerd Font 11",
...
client.connect_signal("request::titlebars", function(c)
	...
	awful.titlebar(c):setup({
		...
		{ -- Right
			awful.titlebar.right.floatingbutton(c),
...
awful.spawn.single_instance("flatpak run com.Dropbox.Client")
